...
use Sf\PayboxGateway\Requests\PayboxDirect\Authorization;
use Sf\PayboxGateway\Requests\PayboxDirect\AuthorizationWithCapture;
use Sf\PayboxGateway\Requests\PayboxDirect\Capture;
use Sf\PayboxGateway\Requests\PayboxDirect\Refund;
use Sf\PayboxGateway\Requests\PayboxDirect\SubscriberAuthorizationWithCapture;
use Sf\PayboxGateway\Requests\PayboxDirect\SubscriberCapture;
use Sf\PayboxGateway\Requests\PayboxDirect\SubscriberDelete;
use Sf\PayboxGateway\Requests\PayboxDirect\SubscriberRegister;
use Sf\PayboxGateway\Responses\PayboxDirect\Authorization as AuthorizationWithoutCaptureResponse;
...
use Sf\PayboxGateway\Responses\PayboxDirect\Refund as RefundResponse;
...
use Sf\PayboxGateway\Responses\PayboxDirect\SubscriberCapture as SubscriberCaptureResponse;
use Sf\PayboxGateway\Responses\PayboxDirect\SubscriberDelete as SubscriberDeleteResponse;
use Sf\PayboxGateway\Responses\PayboxDirect\SubscriberRegister as SubscriberRegisterResponse;
use Sf\PayboxGateway\Services\Exceptions\InvalidAmountException;
use Sf\PayboxGateway\Services\Exceptions\InvalidCallNumberException;
use Sf\PayboxGateway\Services\Exceptions\InvalidCardControlNumberException;
use Sf\PayboxGateway\Services\Exceptions\InvalidCardExpirationDateException;
use Sf\PayboxGateway\Services\Exceptions\InvalidCardNumberException;
use Sf\PayboxGateway\Services\Exceptions\InvalidReferenceException;
use Sf\PayboxGateway\Services\Exceptions\InvalidSubscriberNumberException;
use Sf\PayboxGateway\Services\Exceptions\InvalidTransactionNumberException;
use Sf\PayboxGateway\Services\Exceptions\InvalidWalletException;
use Sf\PayboxGateway\Services\Exceptions\OperationFailedException;
use Sf\PayboxGateway\Services\Exceptions\WalletHasExpiredException;
use Carbon\Carbon;
use Exception;
...
class PayboxDirect
{
  ...
  public static function deleteWallet($wallet)
  {
    ...
    $response = $request->setWallet($wallet)->send();
